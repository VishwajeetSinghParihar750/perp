...
const USERFILL_CREATED_SCHEMA = BASE_EVENT_SCHEMA.extend({
  payload: USERFILL_CREATED_PAYLOAD_SCHEMA,
});
...
type USERFILL_CREATED_EVENT = z.infer<typeof USERFILL_CREATED_SCHEMA>;
